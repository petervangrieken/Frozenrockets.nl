...
$res = preg_match("^i/([0-9]+)/(.*)^i", $requesturi , $matches);
...
define('DEFAULT_Q', 90);
define('DEFAULT_ZC', 'resize');
define('NOT_FOUND_IMAGE', '');
define('ERROR_IMAGE', '');

$_GET['src'] = urldecode($matches[2]);
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './images/cache/thumbs/');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
